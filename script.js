...
function initRecipes() {
    ...
    const recipes = {
        ugali: {
            image: 'https://i.pinimg.com/1200x/fa/8e/03/fa8e03bad48021d28a3181e5e2e4afb0.jpg',
            ingredients: '• 2 cups white cornmeal\n• 3 cups water\n• 1 tsp salt',
            steps: '1. Boil water with salt\n2. Gradually add cornmeal while stirring\n3. Cook for 15-20 minutes until thick\n4. Form into a mound and serve with your choice of stew and vegetables',
            nutrition: 'Calories: 180 per serving\nCarbohydrates: 38g\nProtein: 4g\nFat: 1g'
        },
        jollof: {
            image: 'https://i.pinimg.com/1200x/a7/4b/cb/a74bcb0ac99a32475e945016731d8d39.jpg',
        ...
        injera: {
            image: 'https://i.pinimg.com/1200x/3d/51/bd/3d51bd3ba5e62f842558c025198a8d5d.jpg',
        ...
        bobotie: {
            image: 'https://i.pinimg.com/1200x/d7/b5/05/d7b505f7fed0a94b89c3a65ad6f32168.jpg',
            ingredients: '• 500g ground beef\n• 1 onion, chopped\n• 2 slices white bread\n• 1 cup milk\n• 2 eggs\n• 2 tbsp curry powder\n• 1 tbsp chutney\n• 1 tbsp apricot jam\n• 1 tbsp vinegar\n• 1 tsp turmeric\n• Salt and pepper\n• Bay leaves',
            steps: '1. Soak bread in half the milk, squeeze out and crumble.\n2. Fry onion, add curry powder and turmeric.\n3. Add beef, cook until browned.\n4. Add bread, chutney, jam, vinegar, salt, pepper.\n5. Place in baking dish, top with egg and milk mixture, add bay leaves.\n6. Bake at 180°C (350°F) for 40-45 min until set.',
            nutrition: 'Calories: 350 per serving\nCarbohydrates: 18g\nProtein: 22g\nFat: 20g'
        }
    };
        ...
        button.addEventListener('click', function() {
            ...
            if (recipe) {
                ...
                if (recipeImg) {
                    ...
                    recipeImg.alt = this.closest('.recipe-card')?.querySelector('h3')?.textContent?.trim() || 'Selected dish';
                    recipeImg.style.display = 'inline-block';
                }
